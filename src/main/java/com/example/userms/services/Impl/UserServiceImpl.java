...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Override
    public Client SaveUser(MultipartFile picture_file, Long id, String Name, String LastName, String email, Collection<AppRole> appRoles, String password) throws Exception {
        System.out.println(appRoles);
        Client client = new Client(id, Name, LastName, email, null, password);
