...
public class securityConfig extends WebSecurityConfigurerAdapter {
   ...
   UserRepository userRepository;
    ...
    protected void configure(HttpSecurity http) throws Exception {
       ...
       http.authorizeRequests().antMatchers("/api/login/**","/api/user/refreshtoken","/api/user","/api/user/email/{email}","/api/company").permitAll();
        http.authorizeRequests().antMatchers(GET,"/api/user/all","/api/user/**","/api/user/count").hasAnyAuthority("superAdmin");


        http.authorizeRequests().antMatchers(GET,"/api/user/all","/api/user/**","/api/user/count").hasAnyAuthority("admin","superAdmin");
